      ...
      <div>
            ...
            <div className="grid lg:grid-cols-2 mb-12 lg:mb-16">
              <div className="col-span-1">
                <h2 className="text-3xl lg:text-4xl text-primary-dark-blue pb-5">
                  La mejor comunidad de Animal Crossing
                </h2>
                <p className="text-neutral-grayish-blue  text-lg lg:text-base leading-5">
                  Conoce a otros jugadores, comercia con nabos, particia en
                  eventos, chatea
                </p>
              </div>
            </div>
        ...
        <section>
          <div className="container">
            <h2 className="mt-2 text-center text-3xl text-primary-dark-blue mb-5">
        ...
        <section>
          ...
          <div className="text-lg md:text-xl container no-scrollbar flex gap-2 lg:justify-center overflow-x-auto lg:gap-9">
            <New />
            <New />
            <New />
          </div>
